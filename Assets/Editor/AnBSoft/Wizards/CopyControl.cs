...
public class CopyControl : ScriptableObject
{
	...
	[MenuItem("Tools/A&B Software/Copy Control")]
	static void Copy()
	{
		srcControl = (IControl) Selection.activeGameObject.GetComponent("IControl");
	}

	[MenuItem("Tools/A&B Software/Copy Control", true)]
	...
	[MenuItem("Tools/A&B Software/Paste Control", true)]
	...
	[MenuItem("Tools/A&B Software/Paste Control")]
	static void Paste()
	{
		int count=0;
