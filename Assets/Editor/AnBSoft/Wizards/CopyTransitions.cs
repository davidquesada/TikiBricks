...
public class CopyTransitions : ScriptableObject
{
	...
	[MenuItem("Tools/A&B Software/Copy Transitions")]
	static void Copy()
	{
	...
	[MenuItem("Tools/A&B Software/Copy Transitions", true)]
	...
	[MenuItem("Tools/A&B Software/Paste Transitions", true)]
	...
	[MenuItem("Tools/A&B Software/Paste Transitions")]
	static void Paste()
	{
		/*
				if (contList == null)
