...
public class SpriteFont
{
				...
				if (chars != null)
				{
					for (int i = 0; i < chars.Length; ++i)
					{
						...
						if (chars[i].kernings != null)
							...
							{
#if UNITY_IPHONE && !(UNITY_3_0 || UNITY_3_1 || UNITY_3_2 || UNITY_3_3 || UNITY_3_4 || UNITY_3_5 || UNITY_3_6 || UNITY_3_7 || UNITY_3_8 || UNITY_3_9)
								chars[i].kernings[key] = (object) (((float)chars[i].origKernings[key]) * charSpacing);
#else
								chars[i].kernings[key] = charSpacing * chars[i].origKernings[key];
#endif
							}
					}
				}
	...
	bool KerningParser(string line)
	{
		...
		if (ch.kernings == null)
			...
			ch.origKernings = new Dictionary<char,float>();
#endif
